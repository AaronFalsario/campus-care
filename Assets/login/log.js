    ...
    loginBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (dbError || !studentData) {
                ...
                throw new Error('Account not found in student records. Please sign up first.');
            }

            // Store student info in localStorage for dashboard
            const studentInfo = {
    ...
    signupBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (existingStudent) {
                hideLoader();
                showNotification('Student ID already registered. Please use a different ID or login.', true);
                return;
            }
            ...
            if (existingEmail) {
                hideLoader();
                showNotification('Email already registered. Please login instead.', true);
                return;
            }
    ...
    console.log('Login page ready. Please enter your @gordoncollege.edu.ph email to continue.');